...
És important remarcar que la finalitat de l'aplicació no és l'elaboració d'horaris i la distribució de docència de manera automàtica. Per contra, el que es vol aconseguir és una eina específica que no sigui de mal utilitzar i que permeti, gràcies a múltiples ajudes i automatitzacions, realitzar les tasques necessàries manualment.
...
\begin{itemize}
  \item \texttt{\textbf{RF-A7 [1]}}: Visualitzar la llista de les assignacions de Coordinador als diferents estudis del curs acadèmic.
  \item \texttt{\textbf{RF-A8 [1]}}: Assignar un dels Coordinadors encara no assignats a qualsevol dels estudis. Per fer efectiva l'assignació, ha de confirmar-la.
...
\begin{itemize}
  ...
  \item \texttt{\textbf{RF-C2 [1]}}: Visualitzar els horaris dels estudis que ofereixin alguna assignatura compartida amb el grau que gestiona.
...
\begin{itemize}
  \item \texttt{\textbf{RF-D2 [1]}}: Visualitzar els horaris dels estudis que ofereixin alguna assignatura de qualsevol de les àrees del seu departament.
\end{itemize}
...
\subsubsection{Consulta d'horaris d'estudis}
\begin{itemize}
  \item \texttt{\textbf{RF-P3 [2]}}: Visualitzar els horaris dels estudis que ofereixin alguna de les assignatures en què imparteixi docència.
\end{itemize}
...
\begin{itemize}
  ...
  \item Habilitar o deshabilitar el filtratge de blocs horaris d'assignatures comparties el grup dels quals està assignat només a altres estudis.
