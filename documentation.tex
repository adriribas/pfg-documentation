...
%Un dels meus objectius principals i que més em motiven de la informàtica és ajudar la gent a estalviar temps a l'hora de dur a terme tasques o accions quotidianes que repetitives i pesades que podrien automatitzar-se, ja sigui en l'àmbit personal o laboral, de manera que la seva realització resulti més còmoda i pràctica.

Un dels meus obje

%Per aquest motiu, m'ha cridat molt l'atenció la proposta d'aquest projecte. És una molt bona oportunitat per solucionar un problema que s'emporta més temps del que podria ser a tota la gent que s'ocupa de la gestió i elaboració dels horaris de l'escola.
