...
En aquesta secció, es farà un ànalisi dels els objectius i requisits plantejats inicialment en comparació amb els resultats obtinguts.
...
Tal com s'ha vist al capítol~\ref{cap:implantacio}, els resultats obtinguts no només satisfan els objectius principals, sinó que també aporten alguns detalls i funcionalitats extres.

En general, es pot dir que s'ha aconseguit la meta del projecte. No obstant això, al capítol~\ref{cap:intro} també s'indicaven altres objectius amb un pes inferior als anteriors. Més concretament, es tractava de la distribució de docència i de l'assignació d'aules i la visualització dels seus horaris.

Tal com s'havia calculat al capítol~\ref{cap:planificacio}, si no s'acotaven aquests objectius, la finalització del projecte a temps no era possible. No obstant això, també s'havia esmentat que era important implementar l'aplicació pensant en fer una base de codi de qualitat, la qual en facilités un futur desenvolupament.
...
% Diferenciar requisits deixats per futur de les altres coses
...
\begin{itemize}
  ...
  \item Idiomes.
  \item Generació automàtica d'horaris i assignacions
  \item Assignació de profes (manual)
\end{itemize}
