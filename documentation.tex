...
\begin{itemize}
  ...
  \item Permetre la visualització de l'ocupació de les aules, dels horaris dels professors i dels horaris dels grups de cada estudi, entre d'altres vistes que puguin ser d'utilitat pels usuaris.
...
En aquesta secció, es parlarà sobre com està implantada localment l'aplicació del projecte, tant el \textit{front-end} i el \textit{back-end} com el sistema gestor de bases de dades.
